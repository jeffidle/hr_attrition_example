...
confusion_matrix_combo %>%
        gt(group = "algorithm") %>%
        tab_spanner(label = md("*Un-trained*"), columns = vars(n_ut, pct_ut)) %>%
...
Tweak parameters; feature selection; set cost consequences; apply model to all active employees; apply model to randomly generated employees
